...
x = Dense(1, use_bias=False, activation=lambda t: K.log(2.) - K.softplus(t))(x)
...
d_loss = K.mean(- log_sigmoid(x_real_score) - 0.5 * log_sigmoid(- x_fake_score) - 0.5 * log_sigmoid(- x_real_score))
